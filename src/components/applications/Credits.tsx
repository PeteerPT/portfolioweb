...
const CREDITS = [
    {
        ...
        rows: [['Pedro Oliveira', 'All']],
    },
    {
        title: 'Modeling & Texturing',
        rows: [
            ['Pedro Oliveira', 'Texturing, Composition, & UV'],
        ],
    },
    {
        title: 'Sound Design',
        rows: [
            ['Pedro Oliveira', 'Mixing, Composition, & Foley'],
    ...
    },
    {
        ...
        rows: [
            ['Leticia Oliveira, the wife I love so much.'],
            ['Mom and Dad'],
            ['Douglas Henrique'],
        ],
    },
